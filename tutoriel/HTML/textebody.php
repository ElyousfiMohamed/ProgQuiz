...
<div class="wrapper">
    ...
    <div class="naviguer">
        ...
        <ul>
            ...
            <li>
                <a href="textebody.php" class="nav1" style="background-color:#337ab7;" onmouseenter="afficheelement(8)"
                   onmouseleave="afficheelement(0)"></a>
            </li>
            <li>
        ...
        <div class="carousel-inner"
            ...
            <div style="text-align:left; font:16px verdana,sans-serif;">
                <div style="margin:20px 20px 20px 20px;">
                    <p><i class="fas fa-angle-double-right" style="color:red;"></i>Tout texte tapé hors d'une balise est
                        considéré comme du texte "statique" et apparaîtra de ce fait à l'écran</p>
                    <p><i class="fas fa-angle-double-right" style="color:green;"></i>La mise en forme se fait à 2
                        niveaux</p>
                    <p style="margin-left:5%;"><i class="fas fa-angle-double-right"
                                                  style="color:yellow; font-size:10px;"></i>caractères</p>
                    <p style="margin-left:5%;"><i class="fas fa-angle-double-right"
                                                  style="color:yellow; font-size:10px;"></i>paragraphes</p>
                </div>

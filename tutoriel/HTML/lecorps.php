...
<div class="wrapper">
    ...
    <div class="naviguer">
        ...
        <ul>
            ...
            <li>
                <a href="lecorps.php" class="nav1" style="background-color:#337ab7;" onmouseenter="afficheelement(7)"
                   onmouseleave="afficheelement(0)"></a>
            </li>
            <li>
    ...
    <div id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner"
            ...
            <div style="background-color:#d9534f; padding:15px 15px; color:white;">
                <h1 style="text-align:center;">Le corps <\body></\body></h1>
            </div>
            <br>
            <div style="text-align:left; font:16px verdana,sans-serif;">
                <div style="margin:20px 20px 20px 20px;">
                    <p><i class="fas fa-angle-double-right" style="color:red;"></i>Permet de définir l'apparence du fond
                        de l'écran et la couleur des éléments textuels</p><br>
                    <p><i class="fas fa-angle-double-right" style="color:green;"></i>Une balise Body et une seule par
                        page </p><br>
                    <p><i class="fas fa-angle-double-right" style="color:yellow;"></i>Elle peut s'employer seule ou avec
                        une ou plusieurs de ses options</p><br>
                    <p><i class="fas fa-angle-double-right" style="color:blue;"></i>Est placée immédiatement après la
                        balise </\head></p><br>
                    <p><i class="fas fa-angle-double-right" style="color:grey;"></i></\body> est placé immédiatement
                    avant la balise
                </
                \html></p>
            </div>

...
<div class="wrapper">
    ...
    <div class="naviguer">
        ...
        <ul>
            ...
            <li>
                <a href="lignehorizontale.php" class="nav1" style="background-color:#337ab7;"
                   onmouseenter="afficheelement(11)" onmouseleave="afficheelement(0)"></a>
            </li>
            <li>
    ...
    <div id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner"
            ...
            <div style="background-color:#d9534f; padding:15px 15px; color:white;">
                <h1 style="text-align:center;">Création de lignes horizontales</h1>
            </div>
            <br>
            <div style="text-align:left; font:16px verdana,sans-serif;">
                <div style="margin:20px 20px 20px 20px;">
                    <p><span style="color:blue; font-size:20px;"><\hr size="s" width="w|w%" align = "LEFT|CENTER|RIGHT" color = "#RRVVBB” ></span>
                    </p><br>
                    <p></i><span style="color:blue; font-weight:bold; font-size:20px;">SIZE :</span> épaisseur en pixel
                        de la ligne.</p><br>
                    <p><span style="color:blue; font-weight:bold; font-size:20px;">WIDTH :</span> largeur de la ligne.
                        Peut s'exprimer en valeur absolue (pixels) ou relative (en pourcentage de la largeur de la
                        fenêtre).</p><br>
                    <p><span style="color:blue; font-weight:bold; font-size:20px;">ALIGN :</span> alignement à gauche|au
                        centre|à droite dans la fenêtre (à utiliser si la ligne ne fait pas toute la largeur de la
                        fenêtre).</p><br>
                    <p><span style="color:blue; font-weight:bold; font-size:20px;">COLOR :</span> couleur de la ligne.
                        Option valable avec Internet Explorer.</p><br>
                    <p><span style="color:#4169E1; font-size:20px;"><hr><\hr> seul affiche une ligne grise ombrée de 1 pixel d'épaisseur faisant toute la largeur de la fenêtre</span>
                    </p>
                    <br>

...
<div class="wrapper">
    ...
    <div class="naviguer">
        ...
        <ul>
            <li>
                <a href="htmldef.php" class="nav1" style="background-color:#337ab7;" onmouseenter="afficheelement(1)"
    ...
    <div id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner"
            ...
            <div style="background-color:#d9534f; padding:15px 15px; color:white;">
                <h1 style="text-align:center;">DEFINITION HTML</h1>
            </div>
            <br>


            <div style="text-align:left; font:16px verdana,sans-serif;">
                <div style="background-color:#C2ECEE; padding:16px 32px;">
                    <p>HTML est le langage de balisage standard pour les pages Web.</p>
                    <p>Avec HTML, vous pouvez créer votre propre site Web.</p>
                    <p>Le HTML est facile à apprendre - vous l'apprécierez!</p>
                </div>
                <div style="margin-left:20px;">
                    <h3>Exemples dans chaque chapitre</h3><br>
                    <p>Ce didacticiel HTML contient des centaines d'exemples HTML.</p>
                    <p>Avec notre éditeur HTML en ligne, vous pouvez éditer le HTML et cliquer sur un bouton pour voir
                        le résultat.</p>
                </div>
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <p class="panel-title" id="SECONNECTE">
                                            <?php
                                            $defhtml = "chap1.txt";
                                            $ligne = "";
                ...
                <div style="background-color:#d9534f; padding:16px 32px; color:white; margin:20px 20px 20px 20px;">
                    <H2>Conventions d'écriture</H2>
                </div>
                <br>

                <div style="margin:20px 20px 20px 20px;">
                    <p><i class="fas fa-angle-double-right" style="color:red;"></i>Une page HTML est un fichier ASCII
                        (texte).</p>
                    <p><i class="fas fa-angle-double-right" style="color:green;"></i>Elle est tapée avec un traitement
                        de texte (ex : Notepad++) et enregistrée avec le suffixe .html ou .htm.</p>
                    <p><i class="fas fa-angle-double-right" style="color:blue;"></i>Mais surtout ne pas utiliser le
                        format HTML de Word!.</p>
                    <p><i class="fas fa-angle-double-right" style="color:yellow;"></i>Un commentaire s'écrit entre <\!--
                        et --></script></p>
                </div>

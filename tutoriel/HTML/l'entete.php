...
<div class="wrapper">
    ...
    <div class="naviguer">
        ...
        <ul>
            ...
            <li>
                <a href="l'entete.php" class="nav1" style="background-color:#337ab7;" onmouseenter="afficheelement(5)"
                   onmouseleave="afficheelement(0)"></a>
            </li>
            <li>
    ...
    <div id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner"
            ...
            <div style="background-color:#d9534f; padding:15px 15px; color:white;">
                <h1 style="text-align:center;">L'entete de fichier HTML</h1>
            </div>
            <br>
            <div style="text-align:left; font:16px verdana,sans-serif;">
                <div style="margin:20px 20px 20px 20px;">
                    <p><i class="fas fa-angle-double-right" style="color:red;"></i>Contient des données "informatives"
                        sur la page</p>
                    <p><i class="fas fa-angle-double-right" style="color:green;"></i>Est placé immédiatement après la
                        balise <\html></p>
                    <p><i class="fas fa-angle-double-right" style="color:green;"></i><\title>…</\title> change le titre
                    de la fenêtre dans laquelle la page s'affiche</p>
                    <p><i class="fas fa-angle-double-right" style="color:green;"></i>En fonction des options déclarées,
                        <\meta> va permettre de faciliter la recherche de la page ou de passer automatiquement à une
                        autre page. </p>
                </div>

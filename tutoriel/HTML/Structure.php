...
<div class="wrapper">
    ...
    <div class="naviguer">
        ...
        <ul>
            ...
            <li>
                <a href="Structure.php" style="background-color:#337ab7;" class="nav1" onmouseenter="afficheelement(2)"
                   onmouseleave="afficheelement(0)"></a>
            </li>
            <li>
    ...
    <div id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner"
            ...
            <div style="background-color:#d9534f; padding:15px 15px; color:white;">
                <h1 style="text-align:center;">Structure de fichier HTML</h1>
            </div>
            <br>
            <div style="text-align:left; font:16px verdana,sans-serif;">
                <div style="margin:20px 20px 20px 20px;">
                    <p><i class="fas fa-angle-double-right" style="color:red;"></i>Commence toujours par la balise
                        <\html> pour activer l'interprète HTML</p>
                    <p><i class="fas fa-angle-double-right" style="color:green;"></i>Finit toujours par la balise </p>
                    <p><i class="fas fa-angle-double-right" style="color:blue;"></i>Comporte toujours 2 parties.</p>
                </div>

...
<div class="wrapper">
    ...
    <div class="naviguer">
        ...
        <ul>
            ...
            <li>
                <a href="les fichiers.php" class="nav1" style="background-color:#337ab7;"
                   onmouseenter="afficheelement(4)"
                   onmouseleave="afficheelement(0)"></a>
            </li>
            <li>
    ...
    <div id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner"
            ...
            <div style="background-color:#d9534f; padding:15px 15px; color:white;">
                <h1 style="text-align:center;">Les fichiers</h1>
            </div>
            <br>
            <div style="text-align:left; font:16px verdana,sans-serif;">
                <div style="margin:20px 20px 20px 20px;">
                    <p><i class="fas fa-angle-double-right" style="color:red;"></i>Si le fichier est stocké sur le même
                        site que la page appelante, il faut toujours indiquer les noms de fichiers sous leur forme
                        relative, c'est à dire indiquer en plus de leur nom, leur chemin d'accès par rapport à la page
                        qui est affichée</p>
                    <p style="margin-left:5%;"><i class="fas fa-angle-double-right"
                                                  style="color:blue; font-size:10px;"></i>. pour désigner le même
                        répertoire</p>
                    <p style="margin-left:5%;"><i class="fas fa-angle-double-right"
                                                  style="color:blue; font-size:10px;"></i>.. pour le répertoire père</p>
                    <p><i class="fas fa-angle-double-right" style="color:green;"></i>Si le fichier est stocké sur site
                        web différent de la page appelante, il faut utiliser la notation absolue</p>
                    <p style="margin-left:5%;"><i class="fas fa-angle-double-right"
                                                  style="color:red; font-size:10px;"></i>toujours commencer le nom du
                        fichier par http://…</p>
                    <p style="margin-left:5%;"><i class="fas fa-angle-double-right"
                                                  style="color:red; font-size:10px;"></i>il faut reprendre ce qui est
                        affiché dans la barre d'adresse du navigateur</p>
                </div>
